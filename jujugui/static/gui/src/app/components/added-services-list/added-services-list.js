...
import AddedServicesListItem from '../added-services-list-item/added-services-list-item' // eslint-disable-line max-len
...
class AddedServicesList extends React.Component {
  ...
  */
  disableFocusStateOnChildren(serviceId) {
